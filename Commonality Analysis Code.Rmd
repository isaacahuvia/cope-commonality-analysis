...
cope_ca_ssi_completers <- cope_ca_ssi_completers[complete.cases(cope_ca_ssi_completers$b_cdi_sum,
                                                           cope_ca_ssi_completers$b_gad_mean,
                                                          cope_ca_ssi_completers$b_drs_month,
                                                          cope_ca_ssi_completers$b_cts_rs_mean), ]
...
mutate(across(c(b_drs_month, f1_drs_month, starts_with(c("b_dem_gender", "b_dem_sex", "b_dem_rom", "b_dem_race"))), factor))
...
cope_ca_ssi_completers <- cope_ca_ssi_completers %>%
  mutate(b_dem_sex = fct_lump_min(b_dem_sex, 10),
         b_dem_gender = fct_lump_min(b_dem_gender, 10),
         b_dem_orientation = fct_lump_min(b_dem_orientation, 10),
         b_dem_sex_experience = fct_lump_min(b_dem_sex_experience, 10),
         b_dem_sex_attract = fct_lump_min(b_dem_sex_attract, 10),
         b_dem_rom_attract = fct_lump_min(b_dem_rom_attract, 10), 
         b_dem_race = fct_lump_min(b_dem_race, 10),
         b_dem_language = fct_lump_min(b_dem_language, 10),
         b_dem_zip_code = fct_lump_min(b_dem_zip_code, 10),
         b_dem_grade = fct_lump_min(b_dem_grade, 10))
